...
export default function HeroSection() {
    ...
    const specialFeatures = [
        ...
        "Fast Generation",
        "Generated your new thumbnail in 5 minutes",
    ];
    ...
    return (
        <div className="relative flex flex-col items-center justify-center px-4 md:px-16 lg:px-24 xl:px-32">
            ...
            >
                ...
                <span className="move-gradient px-3 rounded-xl text-nowrap">Next Video.</span>
            </motion.h1>
            <motion.p className="text-base text-center text-slate-200 max-w-lg mt-6"
                ...
                transition={{ delay: 0.2, type: "spring", stiffness: 320, damping: 70, mass: 1 }}
            >
                Stop wasting hours on design. Get high-quality thumbnails in minutes.
            </motion.p>
            ...
            >
                ...
                <button onClick={()=> navigate("/community")} className="flex items-center gap-2 border border-pink-900 hover:bg-pink-950/50 transition rounded-full px-6 h-11">
                    <EyeIcon strokeWidth={1} />
                    <span>View our community</span>
                </button>
            </motion.div>
