...
export default function FeaturesSection() {
    return (
        <div id="features" className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Features" text2="Why use our generator?" text3="Create stunning thumbnails in seconds, that gets clicks without the hassle." />
                ...
                {featuresData.map((feature: IFeature, index: number) => (
                    ...
                    >
                        <div className="p-6 rounded-xl space-y-4 border border-slate-800 bg-slate-950 max-w-80 w-full">
                            <img className="size-12" src={feature.icon} alt={feature.title} />
            ...
            <div className="mt-40 relative mx-auto max-w-5xl">
                ...
                >
                    PrebuiltUI is designed to help you create stunning thumbnails quickly and easily. With a wide range of customizable templates, you can create eye-catching thumbnails that grab attention and drive clicks. 
                    {/* Whether you're a content creator, marketer, or business owner, PrebuiltUI has everything you need to create professional-quality thumbnails in seconds. */}
                </motion.p>
                <div className="grid grid-cols-1 md:grid-cols-3 mt-8 gap-10">
                    ...
                    >
                        ...
                        <p className="text-slate-300 mt-2">Stop wasting time on thumbnail creation and start building your audience with our AI-powered tools.
                        Our Tool creates designs proven to capture attention.
                        </p>
                        <Link to="/generate" className="group flex items-center gap-2 mt-4 text-pink-600 hover:text-pink-700 transition">
                            Start Creating Now
                            <ArrowUpRight className="size-5 group-hover:-translate-y-0.5 group-hover:translate-x-0.5 group-hover:rotate-360 transition duration-300" />
                        </Link> 
                    </motion.div>
                </div>
            </div>
